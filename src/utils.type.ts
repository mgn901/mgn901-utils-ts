export type PartiallyPartial<T, K extends keyof T> = Partial<Omit<T, K>> &
  Pick<T, K>;
...
export type OmitIndexSignature<T> =
  KnownKeyOf<T> extends keyof T ? Pick<T, KnownKeyOf<T>> : never;
...
export type FieldsOf<T> = OmitByValue<
  T,
  ((...args: never[]) => unknown) | symbol
>;
